        ...
        <div className="footer">
            <div className='footer-inside'>
                ...
                <div className="footer-text">
                    <p className="footer-text-p">Get in touch <br/> with our team.</p>
                </div>  
                ...
                <div className="footer-contrb">
                    ...
                    <div className="footer-contrb-names">
                        <div className='first2'>
                            <a className='tag' href={contact.abdullah} target='blank'>Abdullah Ehsan</a><br/>
                            <a className='tag' href={contact.moez} target='blank'>Abdul Moez</a>
                        </div>
                        <div className='sec2'>
                            <a className='tag'  href={contact.talha} target='blank'>Talha Husnain Bhatti</a><br/>
                            <a  className='tag' href={contact.maha} target='blank'>Syeda Mah Noor Asad</a>
                        </div>
                        <div className='third3'>
                            <a  className='tag' href={contact.rimsha} target='blank'>Rimsha Sarfaraz</a><br/>
                            <a  className='tag' href={contact.husnain} target='blank'>Hasnain Mubeen</a>
                        </div>
                    </div>
